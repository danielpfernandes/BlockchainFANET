...
info('*** Adding base station and sattelite switches\n')
...
info('*** Creating links between drone d2 and satellite\n')
net.addLink(s2, s7, cls=TCLink, delay='100ms', bw=1)
net.addLink(st1, s7)

#info('*** Creating links between satellite and base station\n')
#net.addLink(s6, s7, cls=TCLink, delay='100ms', bw=1)
