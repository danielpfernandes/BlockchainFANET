...
function mn_deps {
    ...
    pushd $MININET_DIR/BlockchainFANET/
...
function of {
    ...
    patch -p1 < $MININET_DIR/BlockchainFANET/util/openflow-patches/controller.patch
...
function install_wireshark {
    ...
    cp -n $MININET_DIR/BlockchainFANET/util/colorfilters $HOME/.wireshark
...
function nox {
    ...
    git am $MININET_DIR/BlockchainFANET/util/nox-patches/*tutorial-port-nox-destiny*.patch
    if [ "$DIST" = "Ubuntu" ] && version_ge $RELEASE 12.04; then
        git am $MININET_DIR/BlockchainFANET/util/nox-patches/*nox-ubuntu12-hacks.patch
    fi
